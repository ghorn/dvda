...
cosProp, sinProp, tanProp, coshProp, sinhProp, tanhProp, expProp, signumProp, negateProp, absProp :: (Eq a, Floating a, Num (Vector a), Show a, Hashable a, Container Vector a) => a -> Bool
...
acosProp, asinProp, atanProp, sqrtProp :: (Floating a, Num (Vector a), Ord a, Show a, Hashable a, Container Vector a) => a -> Property
